            ...
            <div class="card-body mt-2">
              <form @submit.prevent="validateForm">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-12">
                    <input v-validate="'required|min:6'" ref="password" type="password" class="form-control" id="password" name="password" placeholder="Password" v-model="user.password">
...
//                    this.signup()
            ...
            /*,
            signup: function () {
                axios.post('http://vuejsbook.test/api/v1/register', this.user)
                    .then(response => {
